...
While searching for alternatives, I found [tsbridge](https://github.com/jtdowney/tsbridge) which honestly probably would have worked pretty well for my use-case, but since we have AI coding tools now I figured that making my own version with just the features relevant to me would be simple enough and a good learning opportunity for both me and Anthropic.
